-- BetterTogether luacheck config. Thin wrapper over the shared Peavers base (../wow-api).
...
-- base.globals (PeaversChangelogs, SlashCmdList) + this addon's SavedVariables and its
-- public namespace table.
globals = base.globals
for _, g in ipairs({
  "BetterTogether",        -- public namespace table (src/Core/Core.lua)
