...
robocopy . $TARGET_PATH /MIR /XD .git .github .idea .claude tools /XF local_deploy.ps1 local_deploy.sh .gitignore .editorconfig .pkgmeta .peavers.yml .luacheckrc .luarc.json BetterTogether-Spec.md /NFL /NDL /NJH /NJS /nc /ns /np
